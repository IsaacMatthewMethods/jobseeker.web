...
export const SHEMALABS_INITIAL_JOBS: Job[] = [
  {
    id: "job_shemalabs_1",
    title: "Senior Android & Full-Stack Developer",
    company: "ShemaLabs",
    ...
    description: "ShemaLabs is seeking a seasoned Senior Android & Full-Stack Developer to lead architecture across our flagship native mobile applications and modern web control dashboards. You will work closely with product leaders to deliver scalable, high-throughput cloud features.",
  ...
  },
  {
    ...
    salaryRange: "$115,000 - $145,000 / yr",
    salary: "$115,000 - $145,000 / yr",
    jobType: "FULL_TIME",
    type: "Full-Time",
    category: "Design",
    description: "ShemaLabs is looking for a Lead UI/UX Product Designer to craft intuitive, world-class mobile and responsive web design systems for next-generation enterprise and consumer applications.",
    requirements: "4+ years of UX/UI product design experience across both native mobile and web. Mastery of Figma, design systems, auto-layout, interactive variants, and prototyping.",
    responsibilities: [
    ...
    benefits: [
      ...
      "Hybrid flexibility (2 days in SF office / 3 days remote)",
  ...
  },
  {
    ...
    description: "ShemaLabs seeks a Cloud & DevOps Automation Specialist to accelerate our container orchestration pipelines, cloud infrastructure as code (Terraform), and security monitoring.",
    requirements: "3+ years experience managing Google Cloud Platform (GCP) or AWS enterprise architectures. Proficiency with Docker, Kubernetes, Helm, and GitHub Actions. Strong scripting in Python, Bash, or TypeScript.",
    responsibilities: [
      "Build, monitor, and scale Kubernetes clusters and Cloud Run container services",
      "Manage Infrastructure as Code using Terraform and automated GitOps workflows",
      "Implement zero-trust security postures, IAM governance, and automated vulnerability scanning",
      "Optimize cloud infrastructure costs while preserving ultra-low latency SLAs"
    ],
    benefits: [
  ...
  {
    id: "job_shemalabs_4",
    title: "Mobile QA & Test Automation Specialist",
    company: "ShemaLabs",
    location: "Remote / Chicago, IL",
    salaryRange: "$95,000 - $120,000 / yr",
  ...
  {
    id: "job_shemalabs_5",
    title: "Junior Frontend Engineering Intern",
    company: "ShemaLabs",
